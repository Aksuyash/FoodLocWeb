$(function(){
	...
	$('#contact-form').validator().on('submit', function (e) {
		if (!e.isDefaultPrevented()) {
		    ...
		    //alert($(".contact-form #name").val());
			var name = e.currentTarget[0].value;
			var email = e.currentTarget[1].value;
			var subject = e.currentTarget[2].value;
			var message = e.currentTarget[3].value;
			 
		   // return;
			//var name = $("form input[id='name']").val();
			//var email = $("form input[id='email']").val();
			//var subject = $("form input[id='email']").val();
			//var message = $("form input[id='email']").val();
			var contact = { "Name": name, "Email": email, "Subject": subject, "Message": message };
